...
public class Menu extends javax.swing.JFrame {
 Grafo grafo;
    ...
    private void initComponents() {
        ...
        jButton5.setText("Grafo Predeterminado");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(inicio)
                    .addComponent(TextFieldfinal, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void busquedaAleatoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_busquedaAleatoriaActionPerformed
        grafo=new Grafo();
        try{
        String primerNumero = JOptionPane.showInputDialog( "Introduzca el numero de Nodos" );
        int numeroNodo=Integer.parseInt(primerNumero);
        if(!primerNumero.isEmpty()){
            grafo.generardatos(numeroNodo);
        }
