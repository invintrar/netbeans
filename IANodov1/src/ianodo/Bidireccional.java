...
/**
 * Búsqueda bidireccional: - Se llevan a la vez dos búsquedas: una descendente
 * desde el nodo inicial y otra ascendente desde el nodo meta. - Al menos una de
 * estas dos búsquedas debe ser en anchura para que el recorrido ascendente y
 * descendente puedan encontrarse en algún momento. - Cuando se llegue a un nodo
 * que ya había sido explorado con el otro tipo de búsqueda, el algoritmo acaba.
 * - El camino solución es la suma de los caminos hallados por cada búsqueda
