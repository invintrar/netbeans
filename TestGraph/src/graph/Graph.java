...
/**
 * Graph ADT Coded by Amir El Bawab Date: 22 December 2014 License: MIT License
 * ~ Please read License.txt for more information about the usage of this
 * software
*
 */
...
public class Graph<E, T> {
     ...
     * @param label
     * @param weight
     * @return Array of 2 edges if the graph is undirected, array of 1 edge if
    ...
    private void DFS(Vertex<E, T> v, Vertex<E, T>[] DFS, int[] index) {
        ...
        while (incidentEdges.hasNext()) {
            ...
            if (oppositeVertex.getStatus() == Vertex.UNVISITED) {
                ...
                if ((!directed && oppositeVertex.getStatus() == Vertex.VISITED)
    ...
    /**
     * Transitive Closure by Floyd–Warshall Idea: if (i->k->j) then create
     * (i->j) if doesn't already exist
     */
...
/////////////////////////////// HELPER ////////////////////////////////
    /**
     * BFS for detecting connected components and is connected in DiGraphs Idea
     * is to consider the DiGraph as UnDiGraph by concatenating the in and out
     * edges
     */
    ...
    /**
     * Binary search for finding the index of a vertex in an array of vertices
     * using the vertex unique id
     *
     * @param array
     * @param target
    ...
    /**
     * Add vertex to the graph with custom ID Private to avoid possible conflict
     * if used manually
     *
     * @param data
     * @return Vertex
